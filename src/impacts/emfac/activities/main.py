...
def _print_run_banner(workflow: dict[str, object]) -> None:
    ...
    print(f"  Passenger Inventory Activity by EMFAC ID Output: {workflow['paths']['final_activity_emfacid_output_passenger']}")
    ...
    print(f"  Freight Inventory Activity by EMFAC ID Output: {workflow['paths']['final_activity_emfacid_output_freight']}")
